    ...
    useEffect(() => {
        const fetchUserMessages = async () => {
            if (authState && authState?.isAuthenticated) {
                ...
                const messagesResponseJpa = await messagesResponse.json();
                setMessages(messagesResponseJpa._embedded.messages);
                setTotalPage(messagesResponseJpa.page.totalPages)
            }
