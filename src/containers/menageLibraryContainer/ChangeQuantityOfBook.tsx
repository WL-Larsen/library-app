...
export const ChangeQuantityOfBook: React.FC<{ book: BookModel, deleteBook:any }> = (props, key) => {
    ...
    useEffect(() => {
        const fetchBookInState = () => {
            ...
            props.book.copiesAvailable ? setRemaining(props.book.copiesAvailable)
                : setQuantity(0);
        }
        fetchBookInState();
    }, []);
    ...
    return (
        <div className='card mt-3 shadow p-3 mb-3 bg-body rounded'>
            <div className='row g-0'>
                ...
                <button className='mt-3 m1 btn btn-md btn-danger' onClick={deleteBook}>
                    Delete
                </button>
                <button className='m1 btn btn-md btn-primary main-color text-white' onClick={increaseQuantity}>
                    Add Quantity
                </button>
