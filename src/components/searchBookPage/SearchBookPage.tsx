...
import SearchBook from '../../containers/searchBookContainer/SearchBook';
...
const SearchBookPage = () => {
    ...
    const searchHandleChange = () => {
        ...
        if (search === '') {
            ...
            setSearchUrl(`/search/findByTitleContaining?title=${search}&page=<pageNumber>&size=${bookPerPage}`)
        }
    ...
    const categoryField = (value: string) => {
        ...
        if (
            ...
            setSearchUrl(`/search/findByCategory?category=${value}&page=<pageNumber>&size=${bookPerPage}`);
        } else {
            setCategorySelection('Book category');
                ...
                <div>
                        ...
                        <div className='col-4 ' >
                            <div className='dropdown'>
                                ...
                                <ul className='dropdown-menu' aria-labelledby='dropdownMenuButton1'>
                                    <li onClick={() => categoryField("Book category")}>
                    ...
                    {totalAmountOfBooks > 0 ?
                        ...
                        <div className='m-5'>
                            ...
                            <a type="button" className='btn btn-primary main-color btn-md px-4 me-md-2 fw-bold text-white' href="#">Library Services</a>
                        </div>
                    }
